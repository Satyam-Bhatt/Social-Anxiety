...
public class EndGame : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        else
        {
            ...
            //Win State Met
            var audioSrc2 = AudioManager.Instance.GetComponent<AudioSource>();
    ...
    private IEnumerator WinState()
    {
        ...
        while (!MyApproximation(room.transform.eulerAngles.z, 90, 0.1f) || room.transform.localScale != _originalScale)
        {
            ...
            //rotation
            room.transform.rotation = Quaternion.Slerp(room.transform.rotation, Quaternion.Euler(0, 0, 90), Time.deltaTime * 2f);
